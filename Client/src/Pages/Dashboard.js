...
function HomePage() {
    ...
    fetch(url).then(res => res.json()
        ...
        let euro = conteudo.EURBRL.bid /*change to bid*/
            ...
            <div className='content'>
                                    ...
                                    <div class="stat-widget-five">
                                        ...
                                        <div class="stat-content">
                                            <div class="text-left dib">
                                                <div class="stat-text">Index IBOVESPA <span class="count" id="indice">23569</span></div>
                                                <div class="stat-heading">Variation: <span id="variação"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="stat-widget-five">
                                        ...
                                        <div class="stat-content">
                                            <div class="text-left dib">
                                                <div class="stat-text"><span class="count">Dollar</span></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Currency Chart </h4>
                            </div>
                            <div class="row">
                                <Grafico />
                            </div>
